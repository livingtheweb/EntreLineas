...
<header id="masthead" class="header">
    ...
    ====================================================================== -->
    <section class="score-board d-none d-md-block">
            ...
            <div class="board d-flex">
                ...
                <div class="container">
                    <div class="row justify-content-center flex-grow-1 h-100">
                        ...
                        <div class="board-match border-left col-3 px-5 pt-1 pb-3 <?php the_field('jugando'); ?>">
                        ...
                        <div class="board-match border-left border-right col-3 px-5 pt-1 pb-3 <?php the_field('jugando'); ?>">
                            <div class="co_light-gray d-flex align-items-center">
                                <span><?php the_field('periodo'); ?></span>
                                <svg class="pointer animated flash infinite <?php the_field('jugando'); ?>" width="12" height="11">
                                    <circle cx="6" cy="5.5" r="2.75" fill="#ff8837"/>
    ...
    ==================================================================== -->
    <div id="carousel" class="carousel bg_light-blue slide d-none d-lg-block py-lg-2" data-ride="carousel">
