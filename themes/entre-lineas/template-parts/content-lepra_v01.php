<!-- MIXED CONTENT -->
			...
			<div class="row">
				...
				<div class="col col-sm-10 mx-sm-auto col-md-12 mx-md-0 col-lg-8">
					...
					<div class="next-opponent px-0 mb-5">
						...
						<div class="opponent-box bg_lepra-purple d-flex flex-column p-5">
							...
							********************** -->
							...
							<header>
								...
								<h2 class="box-head co_lepra-lgpurple text-uppercase text-center pb-3">
									...
									<div class="col-md-8">
										...
										<div class="card-body">
											...
											<h3 class="card-title">
												...
												<a class="title-lepra co_lepra-purple" href="<?php the_permalink(); ?>"><?php the_title(); ?></a> 
					...
					<div class="mixed-news">
						...
						<div class="row">
							...
							********************** -->
							...
							<article class="news col-md-4 d-md-flex flex-md-column justify-content-md-between pr-md-4">
								...
								<h3 class="news-head bo_bottom bo_lepra-purple text-center pb-4 mt-4 mb-0 text-md-left">
							...
							<article class="news col-md-8 d-md-flex flex-md-column-reverse justify-content-md-between">
								...
								<h3 class="news-head bo_top bo_lepra-purple text-center pb-4 mt-4 mb-0 text-md-left pt-md-4 mt-md-0">
	          		...
	          		<div class="mixed-news highlighted-news bg_lepra-purple p-5 my-5">
					...
					<div class="sidebar-box bg_dark-blue p-5">
						...
						*************** -->
						...
						<div class="twitter bg-light mb-5">
							...
							<a class="twitter-timeline" data-height="850" href="https://twitter.com/CSIRoficial?ref_src=twsrc%5Etfw">Tweets by CSIRoficial</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
						...
						<div class="container-fluid px-0">
							...
							<div class="row no-gutters">
								...
								<div class="banner w-100 mt-5 mb-5">
									...
									<?php if (!function_exists('dynamic_sidebar') || !dynamic_sidebar('Banner-small-top LEPRA')) : ?>
						...
						*********************************************** -->
						...
						<article class="box-article article__lepra article__1 bg_lepra-lgpurple d-flex flex-column justify-content-between p-5">
						...
						<div class="container-fluid px-0">
							...
							<div class="row no-gutters">
								...
								<div class="banner w-100 mt-2 my-5">
									...
									<?php if (!function_exists('dynamic_sidebar') || !dynamic_sidebar('Banner-small-bottom LEPRA')) : ?>
						...
						*********************************************** -->
						...
						<article class="box-article article__lepra article__2 bg_lepra-lgpurple d-flex flex-column justify-content-between p-5">
	...
	<div class="container-fluid">
		...
		<div class="mt-5">		
			...
			<?php if (!function_exists('dynamic_sidebar') || !dynamic_sidebar('Banner-large LEPRA')) : ?>
...
<!-- STATICS -->
	...
	<section id="teams-statics" class="teams-statics">
		...
		<div class="container-fluid">
			...
			<div class="row justify-content-around bg_lepra-purple p-5 flex-md-column flex-lg-row">
